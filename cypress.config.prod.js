...
module.exports = defineConfig({
  ...
  viewportHeight: 667,
  viewportWidth: 375,
  fixturesFolder: "testing/prod/fixtures",
  downloadsFolder: "testing/prod/results/downloads",
  screenshotsFolder: "testing/prod/results/screenshots",
  videosFolder: "testing/prod/results/videos",
  e2e: {
    specPattern: "testing/prod/e2e/**/*.cy.{js,jsx,ts,tsx}",
    supportFile: "testing/prod/support/e2e.{js,jsx,ts,tsx}",
  },
