...
const ReportABug = () => {
    ...
    const getPermissionAsync = async (
        ...
        if (status === "denied") {
            Alert.alert(
                "Cannot be done 😞",
                `If you would like to use this feature, you'll need to enable the ${permission === "mediaLibrary" ? "Photo Library" : "Camera"
        ...
        >
            <View style={tw`flex-grow items-center justify-start mt-4`}>
                <View style={tw`w-full`}>
                    <SubHeadingText style={tw`mt-4`}>What Issue(s) are you having?</SubHeadingText>
                    <TextInput
                        editable={!isLoading}
                        control={control}
