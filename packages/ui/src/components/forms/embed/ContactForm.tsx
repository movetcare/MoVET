      ...
      {submissionSuccess ? (
        <div className="text-center">
          ...
          <p className="text-lg mt-4">
            We have received your message and we will get back to you as soon as
            we can.
          </p>
          <p className="text-lg">
            ...
            order they are received. You will hear from us. We promise. We are
            working hard to give everyone the same service we are known for and
            can&apos;t wait to give you the love and attention you deserve.
          </p>
          <p className="text-lg">
            Our customer service business hours are 9:00AM to 5:00PM (MST),
            Monday through Friday. We are not open on Saturdays and Sundays, so
            messages sent on the weekend may not be answered until at least
            Monday afternoon. We are also closed for Memorial Day, July 4th,
            Labor Day, Thanksgiving, and between Christmas and New Year&apos;s
            Day.
          </p>
          <EmergencyWarning />
        </div>
