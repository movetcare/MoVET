...
export const ClientReviews = ({
  ...
  return (
    <div className="sm:grid sm:grid-cols-2 sm:gap-8">
      <div
        className="bg-white p-8 rounded-xl my-8 sm:my-4 cursor-pointer"
        onClick={() =>
          window.open(
      ...
      >
        <div className="flex flex-row justify-center items-center text-movet-yellow text-3xl my-8">
      ...
      <div
        className="bg-white p-8 rounded-xl my-8 sm:mb-4 sm:-mt-4 cursor-pointer"
        onClick={() =>
          window.open(
            "https://apps.apple.com/us/app/movet-on-demand-vet-services/id1478031556",
            "_blank"
      ...
      >
        ...
        <p className="text-xl text-center mb-4">Best veterinarian</p>
        <i>
      ...
      >
        ...
        <p className="text-xl text-center mb-4">Highly recommend!</p>
        <i>
      ...
      {(showAllReviews || mode === "full") && (
        <>
          ...
          >
            ...
            <p className="text-xl text-center mb-4">WOW</p>
            <i>
