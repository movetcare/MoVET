        ...
        <div className={isAppMode ? "px-4 mb-8" : ""}>
            ...
            {isLoading ? (
              ...
              <>
                <BookingHeader
                  ...
                  description={
                    "Please complete the form below to submit an appointment request."
                  }
                />
                    ...
                    <div>
                      ...
                      <p
                        className={`-mb-2 text-center text-gray flex justify-center items-center text-xs cursor-pointer italic hover:text-movet-brown ease-in-out duration-500${
                          errors &&
                          errors["numberOfPetsWithMinorIllness"]?.message
                            ? " mt-6"
                            : " mt-2"
                        }`}
          ...
          towards humans or other pets?"
                    ...
                    <div className="sm:col-span-2 my-2">
                      ...
                      <label className="block text-sm font-medium text-movet-black font-abside mb-4 mt-8 sm:text-center">
                        What day and time would you like to have your
                        appointment? <span className="text-movet-red">*</span>
                      </label>
                      <Calendar
