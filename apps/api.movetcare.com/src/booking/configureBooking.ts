...
export const configureBooking = async (): Promise<boolean> => {
  ...
  if (alreadyHasConfiguration) {
    ...
    admin
      ...
      .set(
        {
          automatedOpenMonday: true,
          automatedOpenMondayTime: 900,
          automatedCloseMondayTime: 1700,
          automatedOpenTuesday: true,
          automatedOpenTuesdayTime: 900,
          automatedCloseTuesdayTime: 1700,
          automatedOpenWednesday: true,
          automatedOpenWednesdayTime: 900,
          automatedCloseWednesdayTime: 1700,
          automatedOpenThursday: true,
          automatedOpenThursdayTime: 900,
          automatedCloseThursdayTime: 1700,
          automatedOpenFriday: true,
          automatedOpenFridayTime: 900,
          automatedCloseFridayTime: 1700,
          automatedOpenSaturday: true,
          automatedOpenSaturdayTime: 900,
          automatedCloseSaturdayTime: 1700,
          automatedOpenSunday: true,
          automatedOpenSundayTime: 900,
          automatedCloseSundayTime: 1700,
          boutiqueStatus: true,
          clinicStatus: true,
