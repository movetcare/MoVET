        ...
        >
          ...
          <p className="mt-4 text-center mb-6 text-xs w-full mx-auto sm:w-2/3">
            * You&apos;ll know this worked when you refresh the page and see
            there is an &quot;ID Number&quot; value set for the client in ProVet
          </p>
        </div>
      ) : (
        <ul
            ...
            >
              <div className="min-w-0 flex-col w-full justify-center">
                <p className=" mt-2 text-center text-sm">
                  ...
                  (manually added) Client and/or to automatically link a Stripe
                  Customer to an existing Client in ProVet.
                </p>
                <form
                ...
                >
                  ...
                  <p className="my-1 text-center text-xs italic">
                    The existing Client will be emailed an account confirmation
                    link once the process is completed successfully. This will
                    enable them to be able to login to the MoVET mobile apps and
                    access the rest of the MoVET platform.
                  </p>
