...
const Client = () => {
  ...
  const sendPaymentLink = (mode: "SMS" | "EMAIL") => {
    toast(`SENDING PAYMENT LINK ${mode}`, {
      position: "top-center",
      duration: 3500,
      icon: (
        <FontAwesomeIcon
  ...
  const flagClient = () => {
    toast(`FLAGGED FEATURE COMING SOON!`, {
      position: "top-center",
      duration: 3500,
      icon: (
        <FontAwesomeIcon
          ...
          <>
            ...
            <div className="flex-1 px-4 text-lg">
              <div className="flex flex-row items-center w-full pt-8">
                <h3 className="text-2xl m-0 font-extrabold">
              ...
              <div className="mt-4 ml-4 sm:ml-8">
                {/* <div className="mt-2">
                  <b>Error: </b>
                  <span className="italic text-movet-red">
                    &quot;Something went wrong... Please try again!&quot;
                  </span>
                </div> */}
                {/* <div className="mt-2">
                  <b>Account ID: </b>
                  <span className="italic">123456789</span>
                </div> */}
                <div className="mt-2">
                  <b>Customer ID: </b>
                ...
                <div className="mt-2">
                  <b>Phone Number: </b>
                  <span className="italic">{client?.phone}</span>
                </div>
                <div className="mt-2">
                  <b>Address: </b>
                  <span className="italic">
              ...
              <div className="flex flex-row items-center w-full mt-2">
                <FontAwesomeIcon
                  ...
                  size="lg"
                />
                <h3 className="text-2xl m-0 font-extrabold">PAYMENT METHOD:</h3>
