...
export const HoursStatus = () => {
  ...
  const [standardOpenTime, setStandardOpenTime] = useState<any>(null);
  const [standardCloseTime, setStandardCloseTime] = useState<any>(null);
  ...
  const [didTouchHousecallStatus, setDidTouchHousecallStatus] =
    useState<boolean>(false);
  const [didTouchStandardOpenTime, setDidTouchStandardOpenTime] =
    useState<boolean>(false);
  const [didTouchStandardCloseTime, setDidTouchStandardCloseTime] =
    useState<boolean>(false);
  useEffect(() => {
          ...
          <div className="flex justify-center items-center my-4">
            ...
            <div className="flex-col justify-center items-center mx-4">
              ...
              <PatternFormat
                ...
                value={standardOpenTime}
                onBlur={() => setDidTouchStandardOpenTime(true)}
                onValueChange={(target: any) =>
                  setStandardOpenTime(target.value)
                }
                className={
            ...
            <div className="flex-col justify-center items-center mx-4">
              ...
              <PatternFormat
                ...
                type="text"
                valueIsNumericString
                value={standardCloseTime}
                onBlur={() => setDidTouchStandardCloseTime(true)}
                onValueChange={(target: any) =>
                  setStandardCloseTime(target.value)
                }
                className={
                  "focus:ring-movet-brown focus:border-movet-brown py-3 px-3.5 block w-full rounded-lg placeholder-movet-gray font-abside-smooth sm:w-20"
                }
